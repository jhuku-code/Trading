...
def load_all_data():
    ...
    df_categories = [
        symbol_to_category[symbol] for symbol in combined_list if symbol in symbol_to_category
    ]
...
# -----------------------------
if "defi_data_loaded" not in st.session_state:

    combined_df, percent_tvl_dfs, merged_df, category_list_short = load_all_data()

    st.session_state["combined_df"] = combined_df
    st.session_state["percent_tvl_dfs"] = percent_tvl_dfs
    st.session_state["merged_df"] = merged_df
    st.session_state["category_list_short"] = category_list_short
    st.session_state["defi_data_loaded"] = True


combined_df = st.session_state["combined_df"]
percent_tvl_dfs = st.session_state["percent_tvl_dfs"]
merged_df = st.session_state["merged_df"]
category_list_short = st.session_state["category_list_short"]
